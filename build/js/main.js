...
var swiper = new Swiper('.swiper-container', _defineProperty({
  ...
  speed: 700
}, "spaceBetween", 10)); //Show modal window

var modalContainer = document.querySelector('.modal');

var openModal = function openModal(className, btnText) {
  for (var _len = arguments.length, params = new Array(_len > 2 ? _len - 2 : 0), _key = 2; _key < _len; _key++) {
    params[_key - 2] = arguments[_key];
  }

  console.log(params);
  var modalWindow = "<div class=\"modal__overlay\">\n    <div class=\"modal__window\">\n        <form class=\"modal__form\">\n            <h2 class=\"modal__formTitle\">\n                ".concat(params[0] || "\u0414\u043B\u044F \u0442\u043E\u0433\u043E \u0447\u0442\u043E \u0431\u044B \u043F\u043E\u043B\u0443\u0447\u0438\u0442\u044C \u0440\u0430\u0441\u0447\u0451\u0442 \u043F\u0435\u0440\u0435\u0439\u0434\u0438\u0442\u0435 \u0432 \n\t\t\t\t\t\t\t\t\t\u0443\u0434\u043E\u0431\u043D\u044B\u0439 <b>\u0434\u043B\u044F \u0432\u0430\u0441 \u043C\u0435\u0441\u0441\u0435\u043D\u0434\u0436\u0435\u0440 :</b>", "\n\n            </h2>\n            <div class=\"modal__formMessengers\">\n                <img class=\"modal__formMessengersItem\" src=\"./img/modal/modal__telegram.png\" />\n                <img class=\"modal__formMessengersItem\" src=\"./img/modal/modal__whatsapp.png\" />\n            </div>\n            <h3 class=\"modal__formSubtitle\">\n\t\t\t\t").concat(params[1] || "\u0418\u043B\u0438 \u0436\u0435 \u0432\u0432\u0435\u0434\u0438\u0442\u0435 \u043D\u043E\u043C\u0435\u0440 \u0442\u0435\u043B\u0435\u0444\u043E\u043D\u0430 \u0434\u043B\u044F \u043F\u043E\u043B\u0443\u0447\u0435\u043D\u0438\u044F \u043F\u0440\u0430\u0439\u0441\u0430 \u0432\n\t\t\t\t\t\u043B\u044E\u0431\u043E\u043C\n                \t\u0443\u0434\u043E\u0431\u043D\u043E\u043C \u0434\u043B\u044F \u0432\u0430\u0441 \u043C\u0435\u0441\u0441\u0435\u043D\u0434\u0436\u0435\u0440\u0435", "\n            </h3>\n            <div class=\"modal__formRow\">\n                <label class=\"modal__formNameLabel\">").concat(params[2] || "\u0438\u043C\u044F", "</label>\n                <input class=\"modal__formName\" type=\"text\" />\n                <label class=\"modal__formPhoneLabel\">").concat(params[3] || "\u0442\u0435\u043B\u0435\u0444\u043E\u043D", "</label>\n                <input class=\"modal__formPhone\" type=\"text\" />\n                <button class=\"modal__formBtn formBtn btn\" type=\"button\">\n                    ").concat(btnText, "\n                </button>\n            </div>\n        </form>\n        <div class=\"modal__close\" onclick=\"modalContainer.innerHTML = '';\">\n            \xD7\n        </div>\n    </div>\n</div>");
...
openModal('projects__previewDescBtn', 'Позвонить мне');
openModal('gallery__descBtn', 'Скачать Проект');
var unselectedImages = document.querySelectorAll('.gallery__unselectedImagesItem');
var selectedImage = document.querySelector('.gallery__selectedImageItem');
var imageSelectors = document.querySelector('.gallery__selectors');
var rockSelector = document.querySelector('.gallery__selectorsRock');
var woodSelector = document.querySelector('.gallery__selectorsWood');
var sizes = document.querySelectorAll('.projects__sizesItem');
var previewSelectors = document.querySelectorAll('.projects__previewChoose');
var previewImage = document.querySelector('.projects__previewImg');
var index = 0;
var listenedIndexes = [0];
localStorage.setItem('listenedIndexes', listenedIndexes); // selectedImage.setAttribute('src', unselectedImages[index].getAttribute('src'));

sizes[index].classList.toggle('projects__sizesItemActive');
previewImage.setAttribute('src', "./img/projects/projects__preview".concat(index, ".png"));
previewImage.setAttribute('data-id', "./img/projects/projects__preview".concat(index, ".png"));

for (var i = 0; i < unselectedImages.length; i++) {
  unselectedImages[i].addEventListener('click', function (e) {
    console.log(localStorage.getItem('listenedIndexes')[0]);
    index = e.target.getAttribute('data-id'); // e.target.setAttribute('src', oldSrc);

    selectedImage.setAttribute('src', e.target.getAttribute('src'));
    sizes[index].classList.add('projects__sizesItemActive');
    previewImage.setAttribute('src', "./img/projects/projects__preview".concat(index, ".png")); // selectedImage.setAttribute(
    // 	'data-material',
...
for (var _i = 0; _i < sizes.length; _i++) {
  sizes[_i].addEventListener('click', function (e) {
    ...
    previewImage.setAttribute('src', "./img/projects/projects__preview".concat(index, ".png"));
    updateStorage(index);
    console.log(unselectedImages[index].getAttribute('src')); // index = unselectedImages[index].getAttribute('data-id');
    // selectedImage.setAttribute('src', unselectedImages[index]);
  });
}

for (var n = 0; n < previewSelectors.length; n++) {
  previewSelectors[n].addEventListener('click', function (e) {
    index = e.target.getAttribute('data-id');
    selectedImage.setAttribute('src', unselectedImages[index].getAttribute('src'));
...
for (var k = 0; k < imageSelectors.children.length; k++) {
  imageSelectors.children[k].addEventListener('click', function (e) {
    ...
    while (a < unselectedImages.length) {
      if (unselectedImages[a].getAttribute('data=material') != e.target.getAttribute('data-material')) {
      ...
      if (unselectedImages[a].getAttribute('data-material') === e.target.getAttribute('data-material')) {
        ...
        selectedImage.setAttribute('src', unselectedImages[a].getAttribute('src'));
        updateStorage(index);
        index++;
        return index;
      }
...
var updateStorage = function updateStorage(index) {
...
var toggleOutroText = document.querySelector('.outro__viewableTitle');
var outroHiddenText = document.querySelector('.outro__readable');
console.log(outroHiddenText.children.length);
outroHiddenText.style.opacity = '0';
outroHiddenText.style.display = 'none';
outroHiddenText.style.height = '0';
var animSpeed = 200;
toggleOutroText.addEventListener('click', function (e) {
  if (e.target.innerText === 'Прочитать') {
    ...
    e.target.innerText = 'Посмотреть'; // for (let i = 0; i < outroHiddenText.children.length; i++) {
    // 	outroHiddenText.children[i].setAttribute('data-aos', 'zoom-in');
    // 	outroHiddenText.children[i].setAttribute('data-aos-delay', 50);
    // }
  } else {
    outroHiddenText.style.opacity = '0';
    outroHiddenText.style.display = 'none';
